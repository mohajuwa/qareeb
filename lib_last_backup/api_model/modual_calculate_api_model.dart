...
ModualCalculateApiModel modualCalculateApiModelFromJson(String str) => ModualCalculateApiModel.fromJson(json.decode(str));

String modualCalculateApiModelToJson(ModualCalculateApiModel data) => json.encode(data.toJson());
...
class ModualCalculateApiModel {
  ...
  factory ModualCalculateApiModel.fromJson(Map<String, dynamic> json) => ModualCalculateApiModel(
