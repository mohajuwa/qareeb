  ...
  _connectSocket() async {
    ...
    homeApiController.homeApi(uid: userid.toString(),lat: lathome.toString(),lon: longhome.toString()).then((value) {
      ...
      if(homeApiController.homeapimodel!.runnigRide!.isEmpty){
        ...
        pickupcontroller.text = homeApiController.homeapimodel!.runnigRide![0].pickAdd!.title.toString();
        dropcontroller.text = homeApiController.homeapimodel!.runnigRide![0].dropAdd!.title.toString();
        latitudepick = double.parse(homeApiController.homeapimodel!.runnigRide![0].pickLatlon!.latitude.toString());
        longitudepick = double.parse(homeApiController.homeapimodel!.runnigRide![0].pickLatlon!.longitude.toString());
        latitudedrop = double.parse(homeApiController.homeapimodel!.runnigRide![0].dropLatlon!.latitude.toString());
        longitudedrop = double.parse(homeApiController.homeapimodel!.runnigRide![0].dropLatlon!.longitude.toString());
        maximumfare = homeApiController.homeapimodel!.runnigRide![0].maximumFare;
        minimumfare = homeApiController.homeapimodel!.runnigRide![0].minimumFare;
        dropprice = homeApiController.homeapimodel!.runnigRide![0].price.toString();
        priceyourfare = homeApiController.homeapimodel!.runnigRide![0].price!;
        request_id = homeApiController.homeapimodel!.runnigRide![0].id.toString();


        picktitle = homeApiController.homeapimodel!.runnigRide![0].pickAdd!.title.toString();
        picksubtitle = homeApiController.homeapimodel!.runnigRide![0].pickAdd!.subtitle.toString();

        droptitle = homeApiController.homeapimodel!.runnigRide![0].dropAdd!.title.toString();
        dropsubtitle = homeApiController.homeapimodel!.runnigRide![0].dropAdd!.subtitle.toString();

        tot_hour = homeApiController.homeapimodel!.runnigRide![0].totHour.toString();
        tot_time = homeApiController.homeapimodel!.runnigRide![0].totMinute.toString();
        tot_secound = "0";
        ...
        calculateController.calculateApi(context: context,uid: useridgloable.toString(),mid: mid, mrole: mroal, pickup_lat_lon: "$latitudepick,$longitudepick", drop_lat_lon: "$latitudedrop,$longitudedrop", drop_lat_lon_list: onlypass).then((value) {
          ...
          calculateController.calCulateModel!.offerExpireTime = int.parse(homeApiController.homeapimodel!.runnigRide![0].increasedTime.toString());
          calculateController.calCulateModel!.driverId = homeApiController.homeapimodel!.runnigRide![0].dId;
          isanimation = true;
          loadertimer = true;
          offerpluse = false;
          ...
          print("11111(calculateController.calCulateModel!.offerExpireTime)22222:- ${calculateController.calCulateModel!.offerExpireTime}");
          print("11111(calculateController.calCulateModel!.driverId)22222:- ${calculateController.calCulateModel!.driverId}");
        },);
    ...
    socket.close();
      ...
      if(acceptvehrequest["c_id"].toString().contains(useridgloable.toString())){
        ...
        globalDriverAcceptClass.driverdetailfunction(context: context,lat: latitudepick,long: longitudepick,d_id: acceptvehrequest["uid"].toString(), request_id: acceptvehrequest["request_id"].toString());
                      ...
                      child:  Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            textfieldlist.isEmpty ? const SizedBox() :
                            Transform.translate(
                              offset: const Offset(0, -30),
                      ...
                      child: TextField(
                        onTap: () {
                          ...
                          fun().then((value) {
                            ...
                            getCurrentLatAndLong(lathome, longhome).then((value) {
                        ...
                        decoration: InputDecoration(
                            ...
                            focusedBorder: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(25)),borderSide: BorderSide(color: notifier.containercolore)),
                            prefixIcon: Padding(
          ...
          child: Column(
            children: [
              ...
              Row(
                children: [
                  Spacer(),
                  Text("V 1.3",style: TextStyle(color: Colors.grey.withOpacity(0.8),fontWeight: FontWeight.bold),),
                  SizedBox(width: 10),
                ],
              ),
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: Column(
                    children: [
                      isanimation == false ? const SizedBox() :
                      lottie.Lottie.asset("assets/lottie/loadding.json",height: 30),
                          ...
                          InkWell(
                            onTap: () {
                              setState((){
                                if (controller != null && controller!.isAnimating) {
                                  Fluttertoast.showToast(
                                    msg: "Your current request is in progress. You can either wait for it to complete or cancel to perform this action.",
                                  );
                                }else{
                                  Get.back();
                                }
                            ...
                            child: Container(
                              ...
                              child: Center(child: Image(image: AssetImage("assets/close.png"),color: notifier.textColor,height: 20,),),
                            ),
                          )
                        ],
                      ),
                          ...
                          Center(
                            child: SizedBox(
                              ...
                              child:  TextField(
                                ...
                                readOnly: controller != null && controller!.isAnimating ? true : false,
                                onTap: () {
                                  controller != null && controller!.isAnimating ? Fluttertoast.showToast(
                                    msg: "Your current request is in progress. You can either wait for it to complete or cancel to perform this action.",
                                  ) : "";
                                },
                                onSubmitted: (value) {
                        ...
                        trailing: SizedBox(
                          ...
                          child: Transform.scale(
                            ...
                            child: CupertinoSwitch(
                              ...
                              value: light,
                              activeColor: theamcolore,
                              onChanged: controller != null && controller!.isAnimating ? (bool value){
                                Fluttertoast.showToast(
                                  msg: "Your current request is in progress. You can either wait for it to complete or cancel to perform this action.",
                                );
                              } : (bool value) {
                      ...
                      children: [
                        ...
                        CommonButton(containcolore: theamcolore, onPressed1: () {
                          setState((){
                            ...
                            if(double.parse(amountcontroller.text) > maxprice){
                              amountcontroller.clear();
                              toast = 1;
                              print("fffff");
                            }else if(double.parse(amountcontroller.text) < minprice){
                              amountcontroller.clear();
                              toast = 2;
                              print("hhhhh");
                            }else{
                        ...
                        },context: context,txt1: "Book for ${currencyy ?? globalcurrency}${amountcontroller.text}")
                            :
                        AnimatedBuilder(
                                  ...
                                  setState((){
                                    setState((){
                                      ...
                                      if(double.parse(amountcontroller.text) > maxprice){
                                        ...
                                        toast = 0;
                                        // dropprice =
                                        dropprice = double.parse(amountcontroller.text);
                                        mainamount = amountcontroller.text;
                                      }
                                    });
                                  });
                        ...
                        homeApiController.homeapimodel!.runnigRide!.isEmpty ? SizedBox() : homeApiController.homeapimodel!.runnigRide![0].biddingRunStatus == 0 ? SizedBox() :
                        const SizedBox(height: 10,),
                        homeApiController.homeapimodel!.runnigRide!.isEmpty ? SizedBox() : homeApiController.homeapimodel!.runnigRide![0].biddingRunStatus == 0 ? SizedBox() :
                        CommonOutLineButton(bordercolore: theamcolore, onPressed1: () {
                          setState((){
                            // socket.connect();
                            homeApiController.homeapimodel!.runnigRide![0].biddingRunStatus = 0;
                            print("+++++ biddingRunStatus +++++ :- ${homeApiController.homeapimodel!.runnigRide![0].biddingRunStatus}");
                            socatloadbidinfdata();
                          });
                        },context: context,txt1: "Driver Offers"),



                        const SizedBox(height: 10,),
                       StatefulBuilder(builder: (context, setState) {
                         return cancelloader ? Center(child: CircularProgressIndicator(color: theamcolore,),) : CommonOutLineButton(bordercolore: theamcolore, onPressed1: () {
                           setState((){
                             isanimation = false;
                             cancelloader = true;
                             print("++CANCEL LOADER++:- ${cancelloader}");
