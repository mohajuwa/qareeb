                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 10,),
                      cancelloader == true ? Center(child: CircularProgressIndicator(color: theamcolore,),) :  CommonOutLineButton(bordercolore: theamcolore, onPressed1: () {
                        cancelloader = true;
  ...
  driverdetailfunction({required String d_id,required String request_id,required context,required double lat,required double long}){
    ...
    vihicalDriverDetailApiController.vihicaldriverdetailapi(uid: useridgloable.toString(), d_id: d_id, request_id: request_id).then((value) {
      ...
      if(value["Result"] == true){
        ...
        drivercountrycode = "${vihicalDriverDetailApiController.vihicalDriverDetailModel!.acceptedDDetail!.primaryCcode}";
        driverphonenumber = "${vihicalDriverDetailApiController.vihicalDriverDetailModel!.acceptedDDetail!.primaryPhoneNo}";
...
Future rateBottomSheet(){
  ...
  return Get.bottomSheet(
    ...
    GetBuilder<ReviewDataApiController>(builder: (reviewDataApiController) {
      return reviewDataApiController.isLoading ? Center(child: CircularProgressIndicator(color: theamcolore,)) : StatefulBuilder(
