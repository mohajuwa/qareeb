...
Widget CommonTextfiled400({required TextInputType? keyboardType,required String txt,TextEditingController? controller,required BuildContext context, required String? Function(String?) validator}){
  notifier = Provider.of<ColorNotifier>(context, listen: true);
  return TextFormField(
    controller: controller,
    style: TextStyle(color: notifier.textColor),
